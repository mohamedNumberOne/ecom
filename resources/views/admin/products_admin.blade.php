                    ...
                    <div>
                        ...
                        <form class="row g-3 needs-validation" novalidate action="{{ route('add_product') }}"
                            ...
                            <div class="col-md-6  col-12 position-relative">
                                ...
                                <textarea id="validationTooltip07" class="form-control" required rows="10" name="details"></textarea>
                        ...
                        @foreach ($all_pro as $pro)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('update_product_page', $id = $pro->id) }}"
